...
```javascript
normal = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-normal@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-normal/tags). For example,

```javascript
normal = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-normal@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var normal = require( 'path/to/vendor/umd/random-normal/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-normal.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-normal

[test-image]: https://github.com/stdlib-js/random-normal/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/random-normal/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-normal/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-normal?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-normal.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-normal/main
...
[deno-url]: https://github.com/stdlib-js/random-normal/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-normal/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-normal/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-normal/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-normal/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-normal/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-normal/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-normal/main/LICENSE
